...
- **[Alert](https://docs.slack.dev/reference/block-kit/blocks/alert-block)**: Displays alerts, warnings, and informational messages within modals. [Implementation](./src/blocks/alert.js).
...
- **[Data table](https://docs.slack.dev/reference/block-kit/blocks/data-table-block)**: Displays structured, paginated data in rows and columns. [Implementation](./src/blocks/data_table.js).
